...
class AdminController extends Controller
{
    ...
    {
        $order_confirm = Orders::where('status',0)->count();
        $order_deliver = Orders::where('status',1)->count();
        $order_success = Orders::where('status',2)->count();
        $order_cancel = Orders::where('status',3)->count();
        $order_all = Orders::count();
        // Orders::where('customer_id',$cus_id)->where('status','==',1)->where('status','==',0)->count();
