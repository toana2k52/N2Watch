...
class CartController extends Controller
{
    ...
    public function post_add_cart_user($id, Request $req, Cart_user $cart){
        ...
        if($pro_detail->amount < 1 || $pro_detail->amount < $req->quantity){
            return redirect()->back()->with('error','Rất xin lỗi mặt hàng này hiện tại không thể đáp ứng đủ số lượng bạn yêu cầu, nếu cần thiết vui lòng liên hệ hotline để được trợ giúp!');
        }else{
