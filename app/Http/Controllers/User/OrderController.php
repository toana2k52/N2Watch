...
class OrderController extends Controller
{
    ...
    public function add_order_detail_user( Request $req, Cart_user $cart)
    {
        ...
        if(session('cart_user') != 0){
            ...
            $req->merge(['user_name'=>$req->user_name,'user_email'=>$req->user_email,'user_phone'=>$req->user_phone,'user_address'=>$req->user_address,'quantity'=>$tsl,'status'=>0, 'admin_id' => $admin_id]);
