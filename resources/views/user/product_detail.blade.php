...
@section('title','N2Watch.com - Chi tiết sản phẩm')
@section('meta')
<meta name="keywords" content="N2Watch.com - Chi tiết sản phẩm"/>
		...
		<div class="hed-service section_service hidden-sm hidden-xs">
			<div class="service-item">
				<div class="section product-summary">
									<p><span style="font-weight: bold;">Loại vỏ: </span></p>
									<em style="margin-left: 15px;">{{$pro_dt->type}}</em>
									<p><span style="font-weight: bold;">Kính cỡ: </span></p>
									<em style="margin-left: 15px;">{{$pro_dt->size}}</em>
									<p><span style="font-weight: bold;">Loại kính: </span></p>
									<em style="margin-left: 15px;">{{$pro_dt->glass}}</em>
									<p><span style="font-weight: bold;">Chất liệu: </span></p>
									<em style="margin-left: 15px;">{{$pro_dt->material}}</em>
									<p><span style="font-weight: bold;">Loại hình mặt: </span></p>
									<em style="margin-left: 15px;">{{$pro_dt->face_type}}</em>
									<p><span style="font-weight: bold;">Bảo hành: </span></p>
									<em style="margin-left: 15px;">{{$pro_dt->warranty}}</em>
							</div>
			</div>
		</div>
	</aside>
