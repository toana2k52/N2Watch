...
<body>
                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="{{route('admin.index')}}">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="public/admin/assets/images/logo-icon.png" alt="homepage" class="light-logo" style="padding-top: 20px; " />
                        ...
                        <span class="logo-text">
                           <!-- dark Logo text -->
                           <img src="public/admin/assets/images/logo-text.png" alt="homepage" class="light-logo" style="padding-top: 20px; "/>
    ...
    <div class="page-wrapper">
        ...
        <footer class="footer text-center">
            N2Watch.com - Trang quản trị admin - Bản Quyền thuộc về <a href="{{route('user.index')}}">N2Watch.com</a>
        </footer>
        <!-- ============================================================== -->
        <!-- End footer -->
        <!-- ============================================================== -->
